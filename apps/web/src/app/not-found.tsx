  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--bg)", color: "var(--ink)" }}>
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 50% 90%, color-mix(in srgb, var(--go) 4%, transparent) 0%, transparent 50%)" }}
      />
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-[640px]">
          ...
          >
            <span className="w-1.5 h-1.5" style={{ background: "var(--kill)" }} />
            <span className="mono text-[10px] tracking-wider uppercase" style={{ color: "var(--kill)" }}>
              request killed
            </span>
            <span className="mono text-[10px]" style={{ color: "var(--faint)" }}>·</span>
            <span className="mono text-[10px]" style={{ color: "var(--faint)" }}>no signal</span>
          </div>
          ...
          {/* ID line */}
          <div
            className="reveal mt-8 inline-flex items-center gap-3 border px-3 py-2 mono text-[11px]"
            style={{
          ...
          >
            <Link href="/ideas/new" className="btn-p">
              Validate yours →
            </Link>
          ...
          >
            <div className="mono text-[10px] mb-2 text-left" style={{ color: "var(--faint)" }}>OR LOOK ELSEWHERE</div>
            <div
            ...
            >
              {[
                ...
                >
                  ...
                  <span className="mono text-[10px]" style={{ color: "var(--faint)" }}>{slug}</span>
                </Link>
              ))}
            </div>
          </div>
      ...
      >
        <span className="mono text-[10px]" style={{ color: "var(--faint)" }}>© 2026 PledgeOFF</span>
        <span className="mono text-[10px]" style={{ color: "var(--faint)" }}>err_404 · no signal found</span>
      </div>
    </div>
  );
}
