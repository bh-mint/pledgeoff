...
const TAG = "product-decisions" as const;
const cluster = CLUSTER_META[TAG];
const others = (["idea-validation", "founder"] as const).map((t) => CLUSTER_META[t]);

export const metadata: Metadata = {
  title: "Product Decisions — Frameworks & Guides",
  description: cluster.description,
  alternates: { canonical: "https://pledgeoff.com/blog/product-decisions" },
  openGraph: {
    title: "Product Decisions — Frameworks & Guides | PledgeOFF",
    description: cluster.description,
      ...
      <div style={{ background: "var(--bg)", color: "var(--ink)" }}>
        ...
        <div className="w-page-sm" style={{ paddingTop: 56, paddingBottom: 96 }}>
          ...
          <div className="mono text-[10px] uppercase tracking-widest mb-6 flex items-center gap-2" style={{ color: "var(--faint)" }}>
            ...
            <span>›</span>
            <span style={{ color: TAG_COLOR }}>Product Decisions</span>
          </div>
