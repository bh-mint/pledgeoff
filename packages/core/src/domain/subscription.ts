...
export const PLAN_TOOL_GATES: Record<Plan, readonly ToolKey[]> = {
  free:       ['icp_limited'],
  founder:    ['icp', 'comp', 'rev', 'build', 'page', 'features', 'market-landscape', 'interview-guide'],
  team:       ['icp', 'comp', 'rev', 'build', 'page', 'gtm', 'features', 'battlecard', 'market-landscape', 'interview-guide', 'transcript'],
  studio:     ['icp', 'comp', 'rev', 'build', 'page', 'gtm', 'features', 'battlecard', 'market-landscape', 'interview-guide', 'transcript'],
  enterprise: ['icp', 'comp', 'rev', 'build', 'page', 'gtm', 'features', 'battlecard', 'market-landscape', 'interview-guide', 'transcript'],
} as const;
...
export function requiredPlanForTool(tool: ToolKey): Plan {
  if (tool === 'gtm' || tool === 'battlecard' || tool === 'transcript') return 'team';
  return 'founder';
}
